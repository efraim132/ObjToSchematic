    ...
    translations: {
        ...
        assign: {
            ...
            components: {
                ...
                copycat_panels: 'Panels and thin layers',
                copycat_panels_on: 'Use panels, panes, boards and layers for fine steps',
                copycat_panels_off: 'Panels and thin layers off',
                copycat_slopes: 'Copycat slopes (4x+ with approximation)',
                copycat_slopes_on: 'Include slopes, slope layers and vertical slopes',
                copycat_slopes_off: 'Slopes off',
                copycat_preview: 'Preview Copycats',
                copycat_preview_ready: 'Copycat preview: {{blocks}} blocks, {{size}}. {{mode}}',
                copycat_preview_colours: 'Solid voxel colours; assign materials to preview textures.',
                copycat_preview_textures: 'Assigned material textures.',
                copycat_preview_approx: '{{count}} cells are approximated. Slopes are previewed with smooth faces.',
                copycat_preview_loading: 'Fitting Copycat preview...',
                copycat_palette: 'Copycat-safe materials',
                copycat_palette_on: 'Use full-cube Copycat palette instead of selection above',
                copycat_palette_off: 'Use selected palette above',
                dithering: 'Dithering',
        ...
        export: {
            ...
            copycat_result: 'Copycats+: {{input}} input voxels → {{count}} blocks, {{size}} Minecraft blocks ({{resolution}} voxels per block edge). The editor shows input voxels; finer shape fitting can change the exported surface.',
            copycat_approximation: '{{count}} block cells were approximated: {{geometry}} geometry pixels changed and {{material}} retained pixels changed material (16×16×16 pixels per block). Test the schematic in Creative mode.',
            components: {
                exporter: 'Exporter',
                ...
                create: 'Create — 1.21.1 (.nbt)',
                create_copycats: 'Create + Copycats+ — 1.21.1 (.nbt)',
                copycat_resolution: 'Copycat voxels per block edge (model dimensions ÷ this value)',
                copycat_2: '2× — half blocks, exact geometry and colours',
                copycat_4: '4× — quarter-block input, shape fitting',
                copycat_8: '8× — eighth-block input, shape fitting',
                copycat_16: '16× — pixel input, shape fitting (slower)',
                copycat_fidelity: 'Copycat fitting',
                copycat_exact: 'Require exact geometry and materials',
                copycat_approximate: 'Allow approximation and report differences',
